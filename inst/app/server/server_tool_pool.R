# testing scatterplot_mod_server

# csvFile = "/Users/may/myProgram/MST/NCME_2019_workshop/data/pool_3PL.csv"
...
# whenever real_pool_tool$pool is changed, the following will be changed as well
# 1. updateCheckboxGroupInput for cateAttrChoicesCB's choices
# 2. updateCheckboxGroupInput for numeAttrChoicesCB's choices
...
# 
# # A tibble: 223 x 8
# ITEM_ID MODEL    NC PAR_1 PAR_2 PAR_3 CONS_IDS  PSG_ID
# <chr>   <chr> <int> <dbl> <dbl> <dbl> <list>    <chr> 
# 1 item001 3PL       2     1 4.81      0 <chr [1]> psg01 
# 2 item002 3PL       2     1 0.605     0 <chr [1]> psg01 
# 3 item003 3PL       2     1 6.71      0 <chr [1]> psg01 
# 4 item004 3PL       2     1 0.578     0 <chr [1]> psg02 
# in myformassembler
...
# Click Update-Numerical-Attriutes-Choices button for pltos
...
# ------ below is not activately developing any more
...
# dynamically generate plot UI output named "num_plot_i", where i is an integer       
