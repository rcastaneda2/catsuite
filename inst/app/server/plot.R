...
# get IRT plot_ly plots including "Information", "Expected_Score", or "CSEM" (used by ATA output; MST output uses other functions)

# lp_obj = readRDS(file = "/Users/may/myProgram/MST/catsuite/catsuite/lp_obj.rds")
# IRT_fun = "Information"
# data_to_exclude = NULL
# to_showlegend = T
...
# -----------------------------------------------------------
#           Pie Chart or Donut Chart for Categorical Data 
# -----------------------------------------------------------


genDountChart = function (data, field, margin = NULL, opacity = NULL, groupBy = NULL) {
...
# One Categorical Plot
# plotType = "histogram" or "pie" ("histogram does not need to count)

# saveRDS(data, file = "data.rds")
# data <- readRDS(file = "~/myProgram/MST/catsuite/catsuite/data.rds")
...
genOneCateAttrPlot = function (data, attr, plotType = "histogram", groupBy = NULL) {
  ...
  switch(plotType,
         ...
         pie = genDountChart (data, field = attr, margin = m, opacity = opacity, groupBy = groupBy))
...
# categorical or numerical plots
...
# plot_type = "two_cate_var_freq_bar", "one_cate_var_freq_bar", "tow_num_var_scatter",
#             "one_num_one_cate_scatter", "one_num_one_cate_bar"
...
# data is a list of tibble and the numerical variable is one column in the tibble
