...
# item_summary = function (lpObj, group_by, which_var, item_filter) {
# 
#   # group_by = "COGNITIVE_COMPLEXITY"
#   # item_filter = "FORM_1"
# 
#   which_stat = c("Mean","Median","SD","Minimum","Maximum","N")
# 
#   items = lp_obj$items
# 
#   keep_items = switch(item_filter,
#                       "All items" = 1:nrow(items),
#                       "All forms" = lp_obj$output$form$item_ind,
# 
#   items <- lp_obj$items
# 
# 
